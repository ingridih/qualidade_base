...
if(!empty($row)){
	...
	$tipo = $row['CA_TIPO'];
	$data = $row['CA_DATA'];
	$identlab = $row['CA_IDENTIFICACAO_LAB'];
	$obslab = $row['CA_OBS_LAB'];
}
                                                        ...
                                                        <form class="row g-3" id="form">
															...
															<div class="form-group row mb-5 fv-row">
																<div class="col-md-3">
																	...
																	<input type="text" class="form-control mb-2 mb-md-0" name="identlab" id="identlab" placeholder="Identificação da carta." value="<?php echo $identlab ?>" maxlength="450"/>
																</div>
																<div class="col-md-9">
																	<label class="form-label">Observação</label>
																	<input type="text" class="form-control mb-2 mb-md-0" name="obslab" id="obslab" placeholder="Se for necessário adicione uma observação." value="<?php echo $obslab; ?>"  maxlength="500"/>
																</div>
																...
																while($row2 = $query3->fetch()){
																	...
																	echo '<div class="mb-5">
																		...
																		<div id="kt_accordion_3_item_'.$contador.'" class="collapse fs-6 ps-10" data-bs-parent="#kt_accordion_3">
																			...
																			AE_UNIDADE, AE_LQ, AE_VR, AE_ENSAIO
																			...
																			while($row4 = $query4->fetch()){
																				if($row4['AE_ELEMENTO_ID'] != null){
																					...
																					<div class="col-md-1">
																						...
																						echo '<div class="col-md-4">
																							<select class="form-select metodo" data-control="select2" name="metodo" data-placeholder="Selecione o método de análise ou crie.">
																								...
																								echo '<option value="'.$row4['AE_METODO'].'" selected>'.$row4['AE_METODO'].'</option>';
																							echo '</select>
																						</div>
																						<div class="col-md-1 fv-row">
																					...
																					echo '<div class="form-group row mb-5">
																						<div class="col-md-2">
																							<input type="hidden" name="inputhidden" value="'.$row2['PO_ID'].'" />
																							<input type="text" class="form-control elemento" id="" name="elemento" placeholder="" value="'.$row4['AE_ELEMENTO'].'" disabled>
																						</div>
																						<div class="col-md-2 fv-row">
																							<input type="number" class="form-control result" min="0" name="result" placeholder="Insira o resultado" id="'.$row2['PO_ID'].'|'.'" value="'.number_format($row4['AE_RESULTADO'], 2, '.', '').'" disabled>
																						</div>
																						<div class="col-md-4">
																						<select class="form-select metodo" data-control="select2" name="metodo" data-placeholder="Selecione o método de análise ou crie.">
																							<option></option>';
																						...
																						<div class="col-md-4">
																							<button id="'.$row2['PO_ID'].'" type="button" class="btn btn-danger btn-remover" name="btn-remover">
															...
															<div class="form-group row mb-5">
																<div class="col-md-12">
																	<button id="btn-salvar" type="submit" class="btn btn-info  btn-salvar">
																		<span class="indicator-label">
																			Editar Análise
																		</span>
																		<span class="indicator-progress">
					...
					$.post({
						...
						success: function (response) {
							if(response == '1'){
								...
								Swal.fire({
									text: "Análise Alterada com sucesso!",
									icon: "success",
								...
								Swal.fire({
									text: "Esse resultado já foi validado pela qualidade, não poderá mais editar.",
									icon: "warning",
									buttonsStyling: false,
									confirmButtonText: "Ok",
									customClass: {
